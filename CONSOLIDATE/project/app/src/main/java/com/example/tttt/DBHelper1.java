...
public class DBHelper1 extends SQLiteOpenHelper {
    ...
    public static final String COL_7 = "ACCTTYPE";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT," +" USERNAME TEXT, PASSWORD TEXT, EMAIL TEXT, AGE TEXT, PHONENUMBER TEXT, ACCTTYPE TEXT)");
    ...
    public boolean insertData(String username, String password, String email, String age, String phonenumber, String accttype) {
        ...
        contentValues.put(COL_7, accttype);

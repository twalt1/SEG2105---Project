...
public class ClassTest_Deliverable2 {

    private String[] id = {"0", "1", "2"}; // New added since the Class.java is improved
    ...
    public void test_checkClass() {
        ...
        Class c = setUp();
        Class c2 = new Class(id[1], title[2], type[1], description[0], difficulty[1], capacity[2], date[2], time[1], instructor[2], dayOfWeek[1], memberList);
